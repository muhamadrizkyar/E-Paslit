				...
				<div class="col-md-12">
					<div class="card">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-12">
									<form action="<?= base_url('penggunaan/update/' . $penggunaan['id_penggunaan']); ?>" method="POST"
								...
								<select id="bulan" name="bulan" class="form-control <?php echo form_error('bulan') ? 'is-invalid' : '' ?>">
									...
									foreach ($bulan as $key => $nama_bulan) {
										$selected = ($key == $penggunaan['bulan']) ? 'selected' : '';
								...
								<div class="invalid-feedback" style="font-size: 12px;">
									<?php echo form_error('bulan') ?>
                                        ...
                                        <input type="number" id="meter_awal"
                                            ...
                                            name="meter_awal" value="<?= $penggunaan['meter_awal']; ?>" disabled />
                                        <div class="invalid-feedback" style="font-size: 12px;">
