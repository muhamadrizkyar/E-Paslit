									...
									<div class="card shadow-none">
										<div class="card-body bg-secondary-subtle">
											...
											<div class="row">
												...
												<div class="col-12">
													<form action="<?= base_url('tagihan/save/' . $tagihan['id_tagihan']); ?>" method="POST" enctype="multipart/form-data">
 															<!-- <input name='id_pelanggan' type='hidden' class='form-control' value="<?= $pelanggan['id_pelanggan'] ?>"> -->
 															<input name='id_tagihan' type='hidden'  class='form-control' value="<?= $tagihan['id_tagihan'] ?>">
														<label for="largeInput" class="mb-2">Upload Bukti Pembayaran Tagihan</label>
															<input type="file" id="image"
															class="form-control form-control <?php echo form_error('image') ? 'is-invalid' : '' ?>"
															name="image"/>
															<div class="invalid-feedback" style="font-size: 12px;">
																<?php echo form_error('image') ?>
															</div>
														<div class="mt-3">
															<input type="submit" class="btn btn-success" value="Kirim Pembayaran">
