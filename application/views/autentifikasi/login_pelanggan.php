    	...
    	<div class="row border rounded-5 p-3 bg-white shadow box-area">
    		...
    		<div class="d-xxl-block d-xl-block d-lg-block d-md-block d-sm-none d-none col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box"
    			...
    			<center>
    				...
    				<small class="text-white text-wrap text-center" style="width: 17rem;">Daftarkan Akun Anda, Jika
    					Sudah
    					Memiliki Akun Silahkan Masuk, Untuk Melihat Tagihan Listrik Dan Pembayarannya.</small>
    			</center>
    		</div>
    		...
    		<div class="col-md-6 right-box">
    			<div class="row align-items-center">
    				...
    				<form method="POST" action="<?= base_url('autentifikasi'); ?>">
                        ...
                        <div class="row">
    						<small>Tidak Memiliki Akun ? <a href="<?= base_url('autentifikasi/daftar'); ?>">Daftar</a></small>
    					</div>
    				</form>
    			</div>
    		</div>
