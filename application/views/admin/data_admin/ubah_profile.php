					...
					<div class="card">
						<div class="card-header">
							<div class="d-flex align-items-center">
								<a class="btn btn-primary btn-round ml-auto" href="<?= base_url('dashboard-admin'); ?>">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-12">
									<form action="<?= base_url('admin/updateprofile/' . $user['id_user']); ?>"
										...
										<div class="form-group">
											...
											<input type="text" id="nama_admin"
												...
												name="nama_admin" value="<?= $user['nama_admin']; ?>" />
											<div class="invalid-feedback" style="font-size: 12px;">
										...
										<div class="form-group">
											...
											<input type="file" id="image" class="form-control form-control"
												name="image" />
											<img class="mb-3" id="blah"
												src="<?= base_url('assets/image-petugas/') . $user['image']; ?>"
