	...
	<div class="content">
		<div class="page-inner">
			<div class="page-header">
				<h4 class="page-title">Tambah Data Admin-Petugas</h4>
				<ul class="breadcrumbs">
					...
					<li class="nav-item">
						<a href="#">Tambah Data Admin-Petugas</a>
					</li>
				</ul>
			</div>
			<div class="row">
									...
									<form action="<?= base_url('admin/save'); ?>" method="POST"
										...
										<div class="form-group">
											...
											<select
												...
												<option value="<?= $value['id_level']; ?>"><?= $value['nama_level']; ?>
												</option>
												<?php endforeach; ?>
											</select>
											<div class="invalid-feedback" style="font-size: 12px;">
										...
										<div class="form-group">
											...
											<input type="file" id="image" class="form-control form-control"
												name="image" />
											<img id="blah"
												src="<?= base_url('assets/image-petugas/default.jpg') ?>"
