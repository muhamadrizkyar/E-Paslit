	...
	<div class="content">
		<div class="page-inner">
			<div class="page-header">
				<h4 class="page-title">Tambah Data Nomor KWH</h4>
				<ul class="breadcrumbs">
					...
					<li class="nav-item">
						<a href="#">Tambah Data Nomor KWH</a>
					</li>
				</ul>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-12">
									<form action="<?= base_url('catatnokwh/save'); ?>" method="POST"
										...
										<div class="form-group">
											...
											<select
												...
												<option value="<?= $value['id_tarif']; ?>"><?= $value['daya']; ?>
												</option>
												<?php endforeach; ?>
											</select>
											<div class="invalid-feedback" style="font-size: 12px;">
